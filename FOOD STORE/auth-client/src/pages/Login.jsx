        ...
        <div className="h-screen pt-[16vh]">
            <form className='ease-in duration-300 w-[80%] sm:w-max shadow-sm backdrop-blur-md bg-white/80 lg:w-max mx-auto flex flex-col items-center rounded-md px-8 py-5' onSubmit={handleOnSubmit}>
                ...
                <div className="mb-4">
                    ...
                    <input type="email" placeholder='Enter your email' name="email" className="shadow-sm bg-white apperance-none border rounded w-full py-2 px-3 sm:w-[20rem] text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
                </div>
                <div className="mb-4">
                    <label className='block text-gray-700 text-sm mb-2' htmlFor='email'>
                        Password
                    </label>
                    <input type="password" placeholder='********' name="password" className="shadow-sm bg-white apperance-none border rounded w-full py-2 px-3 sm:w-[20rem] text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
                </div>
