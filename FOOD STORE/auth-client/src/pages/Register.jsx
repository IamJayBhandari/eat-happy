...
const Register = () => {
    ...
    const handleOnSUbmit =  (event) => {
        ...
        const passwordConfrim = from.Confrimpassword.value;
        ...
        <div className="w-full mx-auto pt-[16vh]">
            <form className='ease-in duration-300 w-[80%] sm:w-max shadow-sm backdrop-blur-md bg-white/80 lg:w-max mx-auto rounded-md px-8 py-5 'onSubmit={handleOnSUbmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" placeholder='Enter your name' name="name" className="shadow-sm bg-white apperance-none border rounded w-full py-2 px-3  text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
                </div>
                <div className="mb-3">
                    <label className='block text-gray-700 text-sm mb-2' htmlFor='email'>
                        Email
                    </label>
                    <input type="email" placeholder='Enter your email' name="email" className="shadow-sm bg-white apperance-none border rounded w-full py-2 px-3  text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
                </div>
