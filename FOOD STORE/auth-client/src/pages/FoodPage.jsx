                    ...
                    <div className="bg-red-200/[.3] border rounded p-8 text-black mb-5">
                        ...
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <span className="flex items-center space-x-4">
                                ...
                                < span className="text-red-500 px-6 py-2 bg-50 text-lg font-medium">
                                     1  
                                </span>
                                <div className="bg-red-500 relative p-4 cursor-pointer rounded-full text-white">
                        ...
                        <div className="flex flex-col sm:flex-row items-center space-y-6 sm:space-y-0 sm:gap-5 sm:mx-auto sm:justify-center">
                             <button className="bg-white active:scale-90 transition duration-500 transfrom hover:shadow-x1 shadow-md rounded-full px-8 py-2 text-xl font-medium text-[#f54748]">Favorite</button>
                             <button className="bg-[#f54748] active:scale-90 transition duration-500 transfrom hover:shadow-x1 shadow-md rounded-full px-8 py-2 text-xl font-medium text-white"> add to cart </button>
                        </div>
                    </div>
...
//     const getFoodDetails = async () => {
//       try {
//         const res = await axios.get(`http://localhost:8000/api/v1/food/getFoods/${params.id}`);
//         if (res.data.success) {
//           setFoodDetails(res.data.data.food);
//           setFood(res.data.data.food); // Optional: You can set the food details in context if needed
//         }
//       } catch (error) {
//         console.log(error);
//       }
